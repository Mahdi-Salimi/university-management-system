    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "academic_semester",
                    models.CharField(
                        choices=[("1", "Autumn"), ("2", "Winter"), ("3", "Summer")],
                        default="1",
                        max_length=1,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("N", "Withdrawn in Emenrgency"),
                            ("S", "Studying"),
                            ("F", "Failed Student Course"),
                            ("P", "Passed Student Course"),
                        ],
                        default="N",
                        max_length=1,
                    ),
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=5,
                        null=True,
                        validators=[utils.models.choices.grade_validatior],
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "corequisites",
                    models.ManyToManyField(blank=True, related_name="corequisite_of", to="course.course"),
                ),
                (
                    "faculty",
                    models.ForeignKey(
                ...
                (
                    "prerequisites",
                    models.ManyToManyField(blank=True, related_name="prerequisite_of", to="course.course"),
                ),
            ],
        ),
    ]
